...
upload_router.add_api_route("/documents", list_documents_handler, methods=["GET"])
upload_router.add_api_route("/pdf", upload_pdf, methods=["POST"])
...
upload_router.add_api_route("/upload_video", upload_video, methods=["POST"])
